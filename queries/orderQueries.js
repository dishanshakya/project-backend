...
const viewComments = "select comments.*, users.username from comments join users on comments.user_id = users.user_id where order_id = $1"
const viewReplies = "select replies.*, users.username from replies join users on replies.user_id = users.user_id where comment_id = $1"
